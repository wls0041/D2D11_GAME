...
void GeometryUtility::CreateQuad(Geometry<VertexColor>& geometry)
{
	...
	geometry.AddVertex(VertexColor(D3DXVECTOR3(-0.5f, -0.5f, 0.0f), D3DXCOLOR(r, g, b, 1)));
	geometry.AddVertex(VertexColor(D3DXVECTOR3(-0.5f, +0.5f, 0.0f), D3DXCOLOR(r, g, b, 1)));
	geometry.AddVertex(VertexColor(D3DXVECTOR3(+0.5f, -0.5f, 0.0f), D3DXCOLOR(r, g, b, 1)));
	geometry.AddVertex(VertexColor(D3DXVECTOR3(+0.5f, +0.5f, 0.0f), D3DXCOLOR(r, g, b, 1)));
...
void GeometryUtility::CreateCircle(Geometry<VertexColor>& geometry)
{
	...
	geometry.AddVertex(VertexColor(D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXCOLOR(0.4f, 0.5f, 0.8f, 1)));

	for (int i = 1; i <= size; i++)
		geometry.AddVertex(VertexColor(D3DXVECTOR3(cosf(D3DXToRadian(angle * i)), sinf(D3DXToRadian(angle * i)), 0.0f), D3DXCOLOR(0.4f, 0.5f, 0.8f, 1)));
